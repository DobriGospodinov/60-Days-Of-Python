...
class App:
    def __init__(self, root):
        ...
        tk.Label(self.login_frame, text="Username").grid(row=0, column=0, sticky="w") # "w" stands for "west"
        ...
        self.entry_password = tk.Entry(self.login_frame, show="*") # show attribute hides the password with ****
